 ...
 */
final class Version20241218210528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discipline CHANGE teacher_id teacher_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discipline CHANGE teacher_id teacher_id INT NOT NULL');
    }
}
